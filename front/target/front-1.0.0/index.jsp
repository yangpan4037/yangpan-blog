...
<!--[if lt IE 9]>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/layout/plugins/html5.js"></script>
<![endif]-->

<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/layout/style.css" type="text/css" />


<script type="text/javascript" src="${pageContext.request.contextPath}/resources/layout/js/jquery.js"></script>

<!-- PrettyPhoto start -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/layout/plugins/prettyphoto/css/prettyPhoto.css" type="text/css" />
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/layout/plugins/prettyphoto/jquery.prettyPhoto.js"></script>
<!-- PrettyPhoto end -->

<!-- jQuery tools start -->
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/layout/plugins/tools/jquery.tools.min.js"></script>
<!-- jQuery tools end -->

<!-- Calendar start -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/layout/plugins/calendar/calendar.css" type="text/css" />
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/layout/plugins/calendar/calendar.js"></script>
<!-- Calendar end -->

<!-- ScrollTo start -->
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/layout/plugins/scrollto/jquery.scroll.to.min.js"></script>
<!-- ScrollTo end -->

<!-- MediaElements start -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/layout/plugins/video-audio/mediaelementplayer.css" />
<script src="${pageContext.request.contextPath}/resources/layout/plugins/video-audio/mediaelement-and-player.js"></script>
<!-- MediaElements end -->

<!-- FlexSlider start -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/layout/plugins/flexslider/flexslider.css" type="text/css" />
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/layout/plugins/flexslider/jquery.flexslider-min.js"></script>
<!-- FlexSlider end -->

<!-- iButtons start -->
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/layout/plugins/ibuttons/css/jquery.ibutton.css" type="text/css" />
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/layout/plugins/ibuttons/lib/jquery.ibutton.min.js"></script>
<!-- iButtons end -->

<!-- jQuery Form Plugin start -->
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/layout/plugins/ajaxform/jquery.form.js"></script>
<!-- jQuery Form Plugin end -->

<script type="text/javascript" src="${pageContext.request.contextPath}/resources/layout/js/main.js"></script>
        ...
        <header>
            <div id="header">
            	...
            	<section class="bottom">
                	<div class="inner">
                    	<div id="logo_top"><a href="index.html"><img src="${pageContext.request.contextPath}/resources/images/logo_top.png" alt="BusinessNews" title="BusinessNews" /></a></div>
                ...
                <section class="section_big_dropdown">
                	<div class="inner">
                    	<div class="block_big_dropdown" data-menu="business">
                        	<div class="content">
                            	<div class="image">
                                	<a href="blog_post.html" class="pic"><img src="${pageContext.request.contextPath}/resources/images/pic_big_drop_3.jpg" alt="" /></a>
                                    <p><a href="blog_post.html">Embarrassing hidden in the middleany thing</a></p>
                                </div>
                                <div class="line"></div>
                                
                                <div class="image">
                                	<a href="blog_post.html" class="pic"><img src="${pageContext.request.contextPath}/resources/images/pic_big_drop_4.jpg" alt="" /></a>
                        ...
                        <div class="block_big_dropdown" data-menu="technology">
                        	<div class="content">
                            	<div class="image">
                                	<a href="blog_post.html" class="pic"><img src="${pageContext.request.contextPath}/resources/images/pic_big_drop_5.jpg" alt="" /></a>
                                    <p><a href="blog_post.html">Simply dummy text of the printing.</a></p>
                                </div>
                                <div class="line"></div>
                                
                                <div class="image">
                                	<a href="blog_post.html" class="pic"><img src="${pageContext.request.contextPath}/resources/images/pic_big_drop_6.jpg" alt="" /></a>
                    	...
                    	<div class="block_big_dropdown" data-menu="education">
                        	<div class="content">
                            	<div class="image">
                                	<a href="blog_post.html" class="pic"><img src="${pageContext.request.contextPath}/resources/images/pic_big_drop_1.jpg" alt="" /></a>
                                    <p><a href="blog_post.html">Many desktop packages and web page editors.</a></p>
                                </div>
                                <div class="line"></div>
                                
                                <div class="image">
                                	<a href="blog_post.html" class="pic"><img src="${pageContext.request.contextPath}/resources/images/pic_big_drop_2.jpg" alt="" /></a>
                	...
                	<div class="main_content">
                        ...
                        <div class="block_home_slider">
                        	<div id="home_slider" class="flexslider">
                            	<ul class="slides">
                                	<li>
                                    	<div class="slide">
                                            <img src="${pageContext.request.contextPath}/resources/images/pic_home_slider_1.jpg" alt="" />
                                            <div class="caption">
                                    ...
                                    <li>
                                    	<div class="slide">
                                            <img src="${pageContext.request.contextPath}/resources/images/pic_home_slider_2.jpg" alt="" />
                                            <div class="caption">
                                    ...
                                    <li>
                                    	<div class="slide">
                                            <img src="${pageContext.request.contextPath}/resources/images/pic_home_slider_3.jpg" alt="" />
                                            <div class="caption">
                                                <p class="title">Many desktop publishing packages and web page.</p>
                                    ...
                                    <li>
                                    	<div class="slide">
                                            <img src="${pageContext.request.contextPath}/resources/images/pic_home_slider_4.jpg" alt="" />
                                            <div class="caption">
                                                <p class="title">Many desktop publishing packages and web page.</p>
                        ...
                        <div class="block_home_col_1">
                        	<div class="block_home_post">
								<div class="pic">
									<a href="news_post.html" class="w_hover">
										<img src="${pageContext.request.contextPath}/resources/images/pic_home_news_1.jpg" alt="" />
										<span></span>
									</a>
								</div>
                            ...
                            <div class="block_home_post">
								<div class="pic">
									<a href="news_post.html" class="w_hover">
										<img src="${pageContext.request.contextPath}/resources/images/pic_home_news_2.jpg" alt="" />
										<span></span>
									</a>
								</div>
                            ...
                            <div class="block_home_post">
								<div class="pic">
									<a href="news_post.html" class="w_hover">
										<img src="${pageContext.request.contextPath}/resources/images/pic_home_news_3.jpg" alt="" />
										<span></span>
									</a>
								</div>
                        ...
                        <div class="block_home_col_2">
                            ...
                            <div class="block_home_post">
								<div class="pic">
									<a href="news_post.html" class="w_hover">
										<img src="${pageContext.request.contextPath}/resources/images/pic_home_news_4.jpg" alt="" />
										<span></span>
									</a>
								</div>
                            ...
                            <div class="block_home_post">
								<div class="pic">
									<a href="news_post.html" class="w_hover">
										<img src="${pageContext.request.contextPath}/resources/images/pic_home_news_5.jpg" alt="" />
										<span></span>
									</a>
								</div>
                            ...
                            <div class="block_home_post">
								<div class="pic">
									<a href="news_post.html" class="w_hover">
										<img src="${pageContext.request.contextPath}/resources/images/pic_home_news_6.jpg" alt="" />
										<span></span>
									</a>
								</div>
                        ...
                        <div class="block_topic_news">
                        	<article class="block_topic_post">
                                ...
                                <div class="f_pic"><a href="news_post.html" class="general_pic_hover scale"><img src="${pageContext.request.contextPath}/resources/images/pic_home_main_news_1.jpg" alt="" /></a></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="news_post.html">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="news_post.html" class="general_pic_hover scale"><img src="${pageContext.request.contextPath}/resources/images/pic_home_main_news_2.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2012</p></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="news_post.html">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="news_post.html" class="general_pic_hover scale"><img src="${pageContext.request.contextPath}/resources/images/pic_home_main_news_3.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2012</p></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="news_post.html">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="news_post.html" class="general_pic_hover scale"><img src="${pageContext.request.contextPath}/resources/images/pic_home_main_news_4.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2012</p></div>
                                    ...
                                    <ul class="slides">
                                        <li>
                                            <div class="block_best_material_post">
                                                <div class="f_pic"><a href="news_post.html" class="w_hover"><img src="${pageContext.request.contextPath}/resources/images/pic_home_best_materials_1.jpg" alt="" /><span></span></a></div>
                                        ...
                                        <li>
                                            <div class="block_best_material_post">
                                                <div class="f_pic"><a href="news_post.html" class="w_hover"><img src="${pageContext.request.contextPath}/resources/images/pic_home_best_materials_2.jpg" alt="" /><span></span></a></div>
                                                <p class="title"><a href="news_post.html">Publishing packages and web page editors their.</a></p>
                                                <div class="info">
                                                    <div class="date"><p>08 July, 2012</p></div>
                                        ...
                                        <li>
                                            <div class="block_best_material_post">
                                                <div class="f_pic"><a href="news_post.html" class="w_hover"><img src="${pageContext.request.contextPath}/resources/images/pic_home_best_materials_3.jpg" alt="" /><span></span></a></div>
                                                <p class="title"><a href="news_post.html">Publishing packages and web page editors their.</a></p>
                                                <div class="info">
                                                    <div class="date"><p>08 July, 2012</p></div>
                                        ...
                                        <li>
                                            <div class="block_best_material_post">
                                                <div class="f_pic"><a href="news_post.html" class="w_hover"><img src="${pageContext.request.contextPath}/resources/images/pic_home_best_materials_4.jpg" alt="" /><span></span></a></div>
                                                <p class="title"><a href="news_post.html">Publishing packages and web page editors their.</a></p>
                                                <div class="info">
                                                    <div class="date"><p>08 July, 2012</p></div>
                                                    <div class="category"><p><a href="#">Business</a></p></div>
                                        ...
                                        <li>
                                            <div class="block_best_material_post">
                                                <div class="f_pic"><a href="news_post.html" class="w_hover"><img src="${pageContext.request.contextPath}/resources/images/pic_home_best_materials_5.jpg" alt="" /><span></span></a></div>
                                                <p class="title"><a href="news_post.html">Publishing packages and web page editors their.</a></p>
                                                <div class="info">
                                                    <div class="date"><p>08 July, 2012</p></div>
                                                    <div class="category"><p><a href="#">People</a></p></div>
                                        ...
                                        <li>
                                            <div class="block_best_material_post">
                                                <div class="f_pic"><a href="news_post.html" class="w_hover"><img src="${pageContext.request.contextPath}/resources/images/pic_home_best_materials_6.jpg" alt="" /><span></span></a></div>
                                                <p class="title"><a href="news_post.html">Publishing packages and web page editors their.</a></p>
                                                <div class="info">
                                                    <div class="date"><p>08 July, 2012</p></div>
                                                    <div class="category"><p><a href="#">Technology</a></p></div>
                      ...
                      <div class="separator" style="height:31px;"></div>
                        ...
                        <div class="block_popular_posts">
                        	...
                        	<div class="article">
								<div class="pic">
									<a href="#" class="w_hover">
										<img src="${pageContext.request.contextPath}/resources/images/pic_popular_post_1.jpg" alt="" />
										<span></span>
									</a>
								</div>
                            ...
                            <div class="article">
								<div class="pic">
									<a href="#" class="w_hover">
										<img src="${pageContext.request.contextPath}/resources/images/pic_popular_post_2.jpg" alt="" />
										<span></span>
									</a>
								</div>
                            ...
                            <div class="article">
								<div class="pic">
									<a href="#" class="w_hover">
										<img src="${pageContext.request.contextPath}/resources/images/pic_popular_post_3.jpg" alt="" />
										<span></span>
									</a>
								</div>
                        ...
                        <div class="block_popular_stuff">
                            ...
                            <div class="content">
                            	...
                            	<div class="media"><a href="http://www.youtube.com/watch?v=ySIvism2af8" class="general_pic_hover play no_fx" data-rel="prettyPhoto" title="Popular Video"><img src="${pageContext.request.contextPath}/resources/images/pic_pop_video.jpg" alt="" /></a></div>
                                <p><a href="blog_post_w_video.html">Publishing packages and web page editors their default model.</a> <img src="${pageContext.request.contextPath}/resources/images/icon_video.gif" alt="" /></p>
...
<!--                             	<script charset="utf-8" src="http://widgets.twimg.com/j/2/widget.js"></script> -->
								<script type="text/javascript" src="${pageContext.request.contextPath}/resources/layout/plugins/tweet/tweet.widget.js"></script>
                                <script type="text/javascript">
                        ...
                        <div class="block_popular_stuff">
                            ...
                            <div class="content">
                            	...
                            	<div class="media"><a href="${pageContext.request.contextPath}/resources/images/pic_pop_photo_big.jpg" class="general_pic_hover zoom no_fx" data-rel="prettyPhoto" title="Popular Photo"><img src="${pageContext.request.contextPath}/resources/images/pic_pop_photo.jpg" alt="" /></a></div>
                                <p><a href="blog_post_w_slider.html">Editors their default model text, and a search for will uncover many.</a> <img src="${pageContext.request.contextPath}/resources/images/icon_photo.gif" alt="" /></p>
                                <p class="date">11 July, 2012</p>
                            </div>
        ...
        <footer>
            <div id="footer">
            	<section class="top">
                	<div class="inner">
                    	<div id="logo_bottom"><a href="index.html"><img src="${pageContext.request.contextPath}/resources/images/logo_bottom.png" alt="" /></a></div>
                        ...
                        <div class="block_footer_widgets">
                        	<div class="column">
                                ...
                                <div class="block_flickr_footer">
                                	<ul>
                                        <li><a href="http://www.flickr.com/" target="_blank"><img src="${pageContext.request.contextPath}/resources/images/pic_flickr_1.png" alt="" /></a></li>
                                        <li><a href="http://www.flickr.com/" target="_blank"><img src="${pageContext.request.contextPath}/resources/images/pic_flickr_2.png" alt="" /></a></li>
                                        <li><a href="http://www.flickr.com/" target="_blank"><img src="${pageContext.request.contextPath}/resources/images/pic_flickr_3.png" alt="" /></a></li>
                                        <li><a href="http://www.flickr.com/" target="_blank"><img src="${pageContext.request.contextPath}/resources/images/pic_flickr_4.png" alt="" /></a></li>
                                        <li><a href="http://www.flickr.com/" target="_blank"><img src="${pageContext.request.contextPath}/resources/images/pic_flickr_5.png" alt="" /></a></li>
                                        <li><a href="http://www.flickr.com/" target="_blank"><img src="${pageContext.request.contextPath}/resources/images/pic_flickr_6.png" alt="" /></a></li>
                                        <li><a href="http://www.flickr.com/" target="_blank"><img src="${pageContext.request.contextPath}/resources/images/pic_flickr_7.png" alt="" /></a></li>
                                        <li><a href="http://www.flickr.com/" target="_blank"><img src="${pageContext.request.contextPath}/resources/images/pic_flickr_8.png" alt="" /></a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="column">
                                ...
                                <div class="block_most_read_news">
                                	<div class="article">
                                    	<div class="pic">
                                        	<a href="news_post.html" class="w_hover">
                                            	<img src="${pageContext.request.contextPath}/resources/images/pic_most_read_1.png" alt="" />
                                                <span></span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="article">
                                    	<div class="pic">
                                        	<a href="news_post.html" class="w_hover">
                                            	<img src="${pageContext.request.contextPath}/resources/images/pic_most_read_2.png" alt="" />
                                                <span></span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="article">
                                    	<div class="pic">
                                        	<a href="news_post.html" class="w_hover">
                                            	<img src="${pageContext.request.contextPath}/resources/images/pic_most_read_3.png" alt="" />
                                                <span></span>
                                            </a>
                                        </div>
    ...
    <div id="login" class="block_popup">
    	<div class="popup">
            ...
            <div class="content">
                ...
                <div class="fb_button"><a href="#"><img src="${pageContext.request.contextPath}/resources/images/button_fb_login.png" alt="" /></a></div>

...
<div class="main">
		...
		<div class="col-lg-9 col-md-12">
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading">
					...
					<h2> <strong>Real-time updates</strong>
					</h2>
	...
	<div class="col-lg-3 col-md-12">
		<div class="panel panel-default">
			<div class="panel-body white-bg"></br/>
		...
		<div class="panel-body">
			<table class="table bootstrap-datatable countries">
				...
				<tbody>
					<tr>
						<td>
							<img src="${contextPath}/resources/assets/ico/flags/Germany.png" style="height:18px; margin-top:-2px;"></td>
						<td>Germany</td>
						<td>2563</td>
						<td>1025</td>
						<td>
					...
					<tr>
						<td>
							<img src="${contextPath}/resources/assets/ico/flags/India.png" style="height:18px; margin-top:-2px;"></td>
						<td>India</td>
						<td>3652</td>
						<td>2563</td>
						<td>
					...
					<tr>
						<td>
							<img src="${contextPath}/resources/assets/ico/flags/Spain.png" style="height:18px; margin-top:-2px;"></td>
						<td>Spain</td>
						<td>562</td>
						<td>452</td>
						<td>
					...
					<tr>
						<td>
							<img src="${contextPath}/resources/assets/ico/flags/Russia.png" style="height:18px; margin-top:-2px;"></td>
						<td>Russia</td>
						<td>1258</td>
						<td>958</td>
						<td>
					...
					<tr>
						<td>
							<img src="${contextPath}/resources/assets/ico/flags/usa.png" style="height:18px; margin-top:-2px;"></td>
						<td>USA</td>
						<td>4856</td>
						<td>3621</td>
						<td>
					...
					<tr>
						<td>
							<img src="${contextPath}/resources/assets/ico/flags/brazil.png" style="height:18px; margin-top:-2px;"></td>
						<td>Brazil</td>
						<td>265</td>
						<td>102</td>
						<td>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body weather widget">
			...
			<div class="today text-center">
				...
				<h4 class="blue">
					<strong><i class="fa fa-map-marker fa-3x red"></i>
						Nevada</strong> 
				</h4>
				...
				<div class="row">
					...
					<div class="col-xs-7 text-left temp">15°C</div>
					<!--/.col-->
		...
		<div class="panel-body weather widget">
			...
			<div class="today text-center">
				...
				<div class="row">
					...
					<div class="col-xs-7 text-left temp">18°C</div>
					<!--/.col-->
	...
	<div class="panel panel-default">
		...
		<div class="panel-body text-center" style="height:230px">
			...
			<span class="pull-left">
				<strong class="blue">$256.256,25</strong>
			</span>
...
<div class="col-lg-3 col-md-6">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body text-center" style="height:230px">
			...
			<span class="pull-left">
				<strong class="blue">$125.365,56</strong>
			</span>
			<span class="pull-right">
				<i class="fa fa-arrow-circle-o-up text-success"></i>
				70%
...
<div class="col-sm-12">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h2>
				<i class="fa fa-bar-chart-o red"></i>
				<strong>xCharts</strong>
			</h2>
			<div class="panel-actions">
				<a href="charts-xcharts.html#" class="btn-setting">
					<i class="fa fa-rotate-right"></i>
				</a>
				<a href="charts-xcharts.html#" class="btn-minimize">
					<i class="fa fa-chevron-up"></i>
				</a>
				<a href="charts-xcharts.html#" class="btn-close">
					<i class="fa fa-times"></i>
				</a>
			</div>
		</div>
					...
					<table class="table bootstrap-datatable datatable small-font">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center text-primary">Active</td>
							</tr>
							<tr>
	...
	<div class="panel panel-default">
		...
		<div class="panel-footer">
			<div class="form-group">
				<input type="email" class="form-control" placeholder="Add new task"></div>
			<div class="btn-group">
